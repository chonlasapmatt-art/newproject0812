...
export function AdminDashboard() {
  ...
  if (status === 'loading') return <main className="admin-lock"><span className="loading-ring" /><p>กำลังตรวจสอบสิทธิ์…</p></main>;
