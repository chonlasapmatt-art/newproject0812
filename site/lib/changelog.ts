...
export const SHIPPED: Change[] = [
  {
    ...
    detail:
      'LINE OA ของร้าน (@490ghfyn) ต่อเข้าเว็บแล้ว ปุ่มขึ้นที่หน้าชำระเงิน หน้าติดตามออเดอร์ ท้ายเว็บ และหน้าติดต่อเรา ลูกค้าที่หาออเดอร์ไม่เจอกดทักร้านได้ทันที',
    where: 'ทุกหน้า',
  },
  {
    date: '2026-08-23',
